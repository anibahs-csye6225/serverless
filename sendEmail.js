  ...
  // The Pub/Sub message is passed as the CloudEvent's data payload.
	...
	if (user) {
        const mailOptions = {
            ...
            text: 'Visit this https://anibahscsye6225.me/v4/user/verifyEmail/' + user.account.username + "/" + token,
            html: '<a href="https://anibahscsye6225.me/v4/user/verifyEmail/' + user.account.username + "/" + token + '"><H2>Click here to verify your account.</H2></a>'
        };
        try {
